...
import fr.fuet.oc.jee.pro.form.ConnexionForm;
...
public class Connexion extends HttpServlet {
	...
	private static String getCookieValue(HttpServletRequest request, String name) throws UnsupportedEncodingException {
	...
	/*
	 * Méthode utilitaire gérant la création d'un cookie et son ajout à la réponse
	 * HTTP.
	 */
